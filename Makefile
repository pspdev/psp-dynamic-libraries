...
all:
	...
	$(PY) $(BUILDTOOLS)/gz/pspgz.py dist/LIBS/idsregeneration.prx $(BUILDTOOLS)/gz/SystemControl.hdr idStorageRegen/idsregeneration.prx pspIdsRegeneration_Driver 0x1007
	$(Q)$(MAKE) -C IOPrivileged
	$(PY) $(BUILDTOOLS)/gz/pspgz.py dist/LIBS/iop.prx $(BUILDTOOLS)/gz/SystemControl.hdr IOPrivileged/iop.prx IoPrivileged 0x1007
	...
	$(Q)$(MAKE) -C PSPFTP
	$(PY) $(BUILDTOOLS)/gz/pspgz.py dist/LIBS/pspftp.prx $(BUILDTOOLS)/gz/UserModule.hdr PSPFTP/pspftp.prx FTPlibPSP 0x0006
	$(Q)$(MAKE) -C PSPIdentHelper
	$(PY) $(BUILDTOOLS)/gz/pspgz.py dist/LIBS/kpspident.prx $(BUILDTOOLS)/gz/SystemControl.hdr PSPIdentHelper/kpspident.prx kpspident 0x1006
	$(Q)$(MAKE) -C USBDeviceDriver
	$(PY) $(BUILDTOOLS)/gz/pspgz.py dist/LIBS/usbdevice.prx $(BUILDTOOLS)/gz/SystemControl.hdr USBDeviceDriver/usbdevice.prx pspUsbDev_Driver 0x1006
	$(Q)echo 'All Done!'
